"""Historical SPY comparison run for Strategy 04 v1.1."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Backtest Strategy 04 v1.1.")
    parser.add_argument(
        "--fifteen-minute",
        type=Path,
    ...
    report = {
        ...
        "warning": "Historical research only; the filter was derived in-sample.",
    }
