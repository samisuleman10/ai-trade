...
def main() -> int:
    parser = argparse.ArgumentParser(description="Download read-only SPY historical bars from IBKR.")
    ...
    try:
        ...
        for timeframe in args.timeframes:
            ...
            csv_path, report_path = save_bars(bars, directory=args.output, symbol="SPY", timeframe=timeframe)
